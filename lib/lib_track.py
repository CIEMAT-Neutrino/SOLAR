def compute_particle_directions(run: dict, configs: dict, params: Optional[dict] = None, trees: list[str] = ["Reco"], rm_branches: bool = False, output: str = "", debug: bool = False):
    """
