...
fig.add_trace(go.Histogram2d(histnorm=density,nbinsx=acc,nbinsy=acc,y=this_df["TNuE"],x=this_df["GammaE"],coloraxis="coloraxis"),row=1,col=2)
fig.add_trace(go.Histogram2d(histnorm=density,nbinsx=acc,nbinsy=acc,y=this_df["TNuE"],x=this_df["VisEnergy"],coloraxis="coloraxis"),row=1,col=3)
fig.add_trace(go.Histogram2d(histnorm=density,nbinsx=acc,nbinsy=acc,y=this_df["TNuE"],x=this_df["Energy"],coloraxis="coloraxis"),row=2,col=1)
fig.add_trace(go.Histogram2d(histnorm=density,nbinsx=acc,nbinsy=acc,y=this_df["TNuE"],x=this_df["TotalAdjClEnergy"],coloraxis="coloraxis"),row=2,col=2)
fig.add_trace(go.Histogram2d(histnorm=density,nbinsx=acc,nbinsy=acc,y=this_df["TNuE"],x=this_df["TotalEnergy"],coloraxis="coloraxis"),row=2,col=3)
