"""
run_analysis.py — Analysis-Only Pipeline (No Detector Steps)
=============================================================
Runs preselection, PDS, TPC, and vertex diagnostics for all configs.
For a full chain including calibration, use run_all.py.
"""
...
# ── CLI ──────────────────────────────────────────────────────────────────────
parser = argparse.ArgumentParser(description="Run analysis-only workflow (no detector steps)")
parser.add_argument(
    "--config",
    type=str,
    nargs="+",
